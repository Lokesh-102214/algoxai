...
const HomePage = () => {
  ...
  return <div className="min-h-screen pt-16 animate-fade-in-up">
      ...
      <section className="relative py-24 px-4 overflow-hidden">
        ...
        <div className="absolute bottom-32 right-20 w-96 h-96 bg-secondary/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: '1.5s'
      }} />
        <div className="absolute top-48 right-32 w-64 h-64 bg-accent/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: '3s'
      }} />
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          animationDelay: '0.3s'
            ...
            <Button size="lg" className="bg-[var(--gradient-primary)] px-8 py-4 text-lg shadow-[var(--shadow-glow-primary)] hover:shadow-[var(--shadow-glow-secondary)] transition-[var(--transition-bounce)] hover:scale-110 btn-glow text-slate-100 bg-emerald-500 hover:bg-emerald-400">
              <Zap className="w-5 h-5 mr-2 animate-pulse" />
              Start Learning
            </Button>
            <Button size="lg" variant="outline" className="px-8 py-4 text-lg border-primary/50 text-primary hover:bg-primary/10 
          ...
          animationDelay: '0.5s'
            ...
            icon: Icon,
            color
          }, index) => <div key={label} className="cp-card-interactive text-center animate-scale-in" style={{
            animationDelay: `${0.7 + index * 0.1}s`
          }}>
                <Icon className={`w-8 h-8 mx-auto mb-3 ${color} animate-float 
                                 group-hover:scale-125 transition-[var(--transition-bounce)]`} style={{
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 gradient-text text-green-300">
          ...
          <div className="cp-grid">
            {cpTopics.map((topic, index) => <div key={topic.slug} style={{
